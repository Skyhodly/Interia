...
***************************************************************************** */
        ...
        da.init();
        const starRate = document.querySelector(".teams__rating");
        const starRateValue = document.querySelector(".teams__rate-valuation");
        starRateValue.innerHTML = `(${starRate.dataset.ratingValue} reviews)`;
